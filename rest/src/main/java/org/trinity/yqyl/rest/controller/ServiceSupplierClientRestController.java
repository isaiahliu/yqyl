...
public class ServiceSupplierClientRestController extends
	...
	public @ResponseBody ResponseEntity<ServiceSupplierClientResponse> reportSuppliers(final ServiceSupplierClientSearchingDto request)
			throws IException {
		final ServiceSupplierClientResponse response = new ServiceSupplierClientResponse();

		final Page<ServiceSupplierClientDto> data = getDomainProcessController().reportSuppliers(request);
