...
public class ServiceOrderRestController extends
    ...
    @Override
    @Authorize(value = AccessRight.DISABLED)
    public ResponseEntity<ServiceOrderResponse> getOne(final Long entityId, final ServiceOrderSearchingDto request) throws IException {
        return super.getOne(entityId, request);
    }
