...
public class CommonAjaxController extends AbstractRestController {
    ...
    @Authorize(AccessRight.ADMINISTRATOR)
    public @ResponseBody DefaultResponse ajaxGetSystemAttribute(@PathVariable("key") final String key) throws IException {
    ...
    @Authorize(AccessRight.ADMINISTRATOR)
    public @ResponseBody DefaultResponse ajaxUpdateSystemAttribute(@RequestBody final SystemAttributeRequest request) throws IException {
        return restfulServiceUtil.callRestService(Url.SYSTEM_ATTRIBUTE_UPDATE, null, request, null, DefaultResponse.class);
    }
}
