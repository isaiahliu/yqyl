...
public class ServiceSupplierAjaxController extends AbstractRestController {
	...
	public @ResponseBody DefaultResponse ajaxReadRequirements() throws IException {
		return restfulServiceUtil.callRestService(Url.SUPPLIER_READ, null, null, null, DefaultResponse.class);
	}
	...
	@Authorize(AccessRight.ADMINISTRATOR)
	public @ResponseBody ServiceSupplierClientResponse ajaxReportSupplier(final ServiceSupplierClientSearchingDto searchingDto)
			throws IException {
		return restfulServiceUtil.callRestService(Url.SUPPLIER_REPORT, null, null, searchingDto, ServiceSupplierClientResponse.class);
	}
