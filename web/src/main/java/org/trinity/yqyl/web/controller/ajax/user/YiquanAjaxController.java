...
public class YiquanAjaxController extends AbstractRestController {
    ...
    public ResponseEntity<DefaultResponse> ajaxBindYiquan(@RequestBody final YiquanRequest request) throws IException {
        final DefaultResponse response = restfulServiceUtil.callRestService(Url.YIQUAN_BIND, null, request, null,
    ...
    public ResponseEntity<YiquanResponse> ajaxGetYiquan(final YiquanSearchingDto request) throws IException {
        final YiquanResponse response = restfulServiceUtil.callRestService(Url.YIQUAN, null, null, request,
                YiquanResponse.class);

        return createResponseEntity(response);
    }

    @RequestMapping(value = "/detail", method = RequestMethod.GET)
    public ResponseEntity<YiquanTxResponse> ajaxGetYiquanDetail(final AccountPostingSearchingDto request)
            throws IException {
        final YiquanTxResponse response = restfulServiceUtil.callRestService(Url.YIQUAN_DETAIL, null, null, request,
                YiquanTxResponse.class);
    ...
    public ResponseEntity<DefaultResponse> ajaxTopUpYiquan(@RequestBody final YiquanRequest request) throws IException {
        final DefaultResponse response = restfulServiceUtil.callRestService(Url.YIQUAN_TOPUP, null, request, null,
                DefaultResponse.class);
    ...
    public ResponseEntity<DefaultResponse> ajaxUnbindYiquan(@RequestBody final YiquanRequest request)
            throws IException {
        final DefaultResponse response = restfulServiceUtil.callRestService(Url.YIQUAN_UNBIND, null, request, null,
                DefaultResponse.class);
